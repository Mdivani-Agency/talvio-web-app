...
-- resumes: authenticated CRUD except pdf pointers (those go through
-- finalize_pdf). user_credits: authenticated SELECT only; writes go
-- through finalize_pdf → consume_credits / handle_new_user /
