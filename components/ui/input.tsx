  ...
  return (
    <div className="relative w-full">
      <input
        ...
        {...props}
      />
      {error && <ErrorBadge error={error} className="absolute right-3 top-1/2 -translate-y-1/2" />}
    </div>
  )
}
